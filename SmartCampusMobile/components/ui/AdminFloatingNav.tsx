...
const TABS: { name: string; Icon: LucideIcon; label: string }[] = [
  ...
  { name: 'TransportManagement', Icon: Bus, label: 'Transport' },
  { name: 'AttendanceReport', Icon: BarChart2, label: 'Reports' },
  { name: 'SchoolProfile', Icon: MoreHorizontal, label: 'More' },
];

export interface AdminFloatingNavProps {
